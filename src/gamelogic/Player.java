...
public class Player extends Knockable implements GameObject {
  private double x;
  private double y;
  ...
  public Player( int startX, int startY, int defaultGameSpeed, double speedModfer ) {
    this.setRadius( 40 );
    this.setX( startX );
    this.setY( startY );
    this.setgamespeed( defaultGameSpeed );
    this.setSpeedModfer( speedModfer );
  }
  public Player( ) {
    this( 400, 500, 1, 0.08 );
  }
