...
public class GameEngine {
   ...
   /* if (!gE.gamePlayingStatePropPointer.getValue( ).equals( GamePlayingState.PLAY )
    ...
    public GameLevel getPlayingLevel() {
        return this.gameLoadedLevelPropPointer.getValue();
    }
    ...
    public IntegerProperty getPlayerPosYProperty() {
        return this.playerPosY;
    }

    public DoubleProperty getGameSpeedProperty() {
        return this.gameSpeed;
    }

    // PROPERTYS - POINTER
    public ObjectProperty<Double> getGamePlayerPosProperty() {
        return this.gamePlayerPosPropPointer;
    }

    public ObjectProperty<Number> getGamePlayerLifePointer() {
        return gamePlayerLifePointer;
    }

    public ObjectProperty<Number> getGamePlayerScoreProperty() {
        return this.gamePlayerScorePropPointer;
    }
